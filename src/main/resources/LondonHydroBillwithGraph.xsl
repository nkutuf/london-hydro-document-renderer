<?xml version="1.0"?>
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:s="http://www.stylusstudio.com/xquery" xmlns:n01="http://londonhydro.com/Matrix/BILL/BillPrint">
    <xsl:template match="/">
                                ...
                                <fo:table width="100%" border-style="outset" border-width="0pt" background-repeat="repeat">
                                    ...
                                    <fo:table-body>
                                        <fo:table-row>
                                            ...
                                            <fo:table-cell border-style="inset" border-width="0pt" padding="2pt" background-repeat="repeat" display-align="center">
                                                <fo:block background-color = "white" font-size = "10pt">
                                                    Meter Number <xsl:value-of select="$DefaultDocument/n01:MT_BillPrint/invextract/invdoc/InvDetails/Service/MeterData/Meter/@MeterNumber"/> Service Numer 183695
                                                </fo:block>
                                        ...
                                        <fo:table-row>
                                            <fo:table-cell border-style="inset" border-width="0pt" padding="2pt" background-repeat="repeat" display-align="center">
                                                <fo:block>
                                                    <fo:external-graphic background="transparent" width="50pt" content-width="scale-to-fit" height="80pt" content-height="scale-to-fit" scaling="non-uniform" src="url(file:///c:/Users/defaultuser0/Downloads/LondonHydroLogo.svg)"/>
                                                </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-style="inset" border-width="0pt" padding="2pt" background-repeat="repeat" display-align="center">
                                                <fo:block>
