                                    ...
                                    <fo:table-row>
                                        <fo:table-cell border-style="inset" border-width="0pt" padding="2pt" background-repeat="repeat" display-align="center">
                                            <fo:block>
                                                ...
                                                <xsl:value-of select="/Letter/CurrentDate"/>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                </fo:table-body>
                            ...
                            <fo:table width="100%" border-style="outset" border-width="0pt" background-repeat="repeat">
                                ...
                                <fo:table-body>
                                    <fo:table-row>
                                        <fo:table-cell border-style="inset" border-width="0pt" padding="2pt" background-repeat="repeat" display-align="center">
                                            <fo:block>
                                                <xsl:value-of select="filecopy:getSubject()"/>
                                                Account Number: <xsl:value-of select="/Letter/AccountData/AccountNumber"/>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                </fo:table-body>
                                    ...
                                    <fo:table-row>
                                        <fo:table-cell border-style="inset" border-width="0pt" padding="2pt" background-repeat="repeat" display-align="center">
                                            <fo:block>
                                                ...
                                                <fo:block>
                                                    Service Adress: <xsl:value-of select="/Letter/AccountData/ServiceAddress"/>
                                                </fo:block>
